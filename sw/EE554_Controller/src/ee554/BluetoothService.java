                	...
                	// Read from the InputStream
	            		...
	            		if (nextCh == 0x00)
	            		{
	            			...
	            			*/
	            			...
	            			{
	            				//Start byte
	            				Log.d("STARTBYTE", "START byte received");
		            			Log.d("STARTBYTE", Byte.toString((byte)nextCh));
	            			...
	            			else if (nextCh == 0x23)
	            			{
	            				...
	            				//End byte
	            				Log.d("ENDBYTE", "END byte received");
		            			Log.d("ENDBYTE", Byte.toString((byte)nextCh));
	            		...
	            		{
	            			//Data Byte 
	            			Log.d("0xFE_BYTE", "0xFE byte received");
	            			...
	            			*/
	            			...
	            			{
	            				//Log.d("BYTE", "Image Data byte received");
		            			//Log.d("BYTE", Byte.toString((byte)nextCh));
